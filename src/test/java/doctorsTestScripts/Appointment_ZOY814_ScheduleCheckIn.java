			...
			if(Schedule.equalsIgnoreCase("Scheduled")||Schedule.equalsIgnoreCase("Rescheduled"))
			{
				...
				Reporter.log("Scheduled/Rescheduled Found");
					...
					if (driver.findElements(By.id("checkIn")).size()>0){
						...
						Thread.sleep(1000);
						driver.findElement(By.id("prognosis")).sendKeys(
								"Normal");
						Thread.sleep(1000);
						...
						driver.findElement(By.id("drugAndInstructions"))
								.sendKeys("Crocin");
						Thread.sleep(1000);
						driver.findElement(By.id("strength")).sendKeys("2");
						Thread.sleep(1000);
						driver.findElement(
								By.xpath("//*[@id='tab-pres']/div[1]/div[2]/div[3]/div[2]/span/input"))
								.click();
						Thread.sleep(1000);
						driver.findElement(By.id("savePrescription")).click();
						Thread.sleep(1000);
						Reporter.log("Prescription Details Saved");
						driver.findElement(By.id("consultationNotes"))
								.sendKeys("Normal");
						Thread.sleep(1000);
						...
						driver.findElement(
								By.xpath("html/body/div[7]/div[3]/div/div[2]/div[2]/div[1]/button"))
								.click();
						System.out
								.println("click on the download Receipt icon");
						Reporter.log("click on the download Receipt icon");
						Thread.sleep(5000);
						driver.findElement(By.xpath("//*[@id='presDownload']"))
								.click();
						Thread.sleep(10000);
						driver.findElement(
								By.xpath("html/body/div[7]/div[3]/div/div[2]/div[2]/div[2]/button"))
								.click();
						Thread.sleep(5000);
						driver.findElement(
								By.xpath("//*[@id='prescriptionPdfShare']"))
								.click();
						Thread.sleep(5000);
						driver.findElement(
								By.xpath("//*[@id='sp-patient-sharepopup']/div/div/div/div/div/span[1]"))
								.click();
						Thread.sleep(5000);
						driver.findElement(By.id("checkOut")).click();
						System.out.print("Clicked on Checkout");
						System.out
								.println("Check-In Scheduled/Rescheduled Sucessfull");
						break;
					}
					...
					System.out.println("Scheduled/Rescheduled is not present");
				}
