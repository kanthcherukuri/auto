 ...
 * 
 * Description- Test case for "Schedule_Consultation" edit follow up days. 
 * Follow ZOY797 JIRA for understanding the manual test case
 */
...
public class Schedule_ZOY797_Doctor_EditFollowUpDays{
  ...
  public void testEditFollowUpDays() throws InterruptedException, ParseException, AWTException {
	  ...
	  WebElement mainMenu = driver.findElement(By.xpath(".//*[@id='followup-days']"));
	  Actions action = new Actions(driver);
	 
	  action.moveToElement(mainMenu,40,20).click().perform();
