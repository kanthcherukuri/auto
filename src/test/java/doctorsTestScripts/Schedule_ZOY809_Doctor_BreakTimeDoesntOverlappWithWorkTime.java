 ...
 * 
 * Description- Test case for adding time slots that do not overlapp with the work timings
 * Follow ZOY809 JIRA for understanding the manual test case
 */
...
public class Schedule_ZOY809_Doctor_BreakTimeDoesntOverlappWithWorkTime{
 ...
 //===============================================================================================================================================================//	
  ...
  public void testBreakTimeDoesntOverlappWithWorkTime(String runmode,String day,String start_time,String end_time) throws InterruptedException, ParseException, AWTException {
	  ...
	  if(actual_text.contains("Lunch Break should be between the start and end slots of the day"))
	  {
	  ...
	  {
		  System.out.println("TEST CASE PASSED, ADDING BREAK TIME SUCCESSFUL");
...
//===============================================================================================================================================================//	
  ...
  public Object[][] DP1() throws Exception{
      ...
      Object[][] retObjArr=TestUtils.getTableArray("TestData\\Doctors_TestData.xls", "Doctor", "ZOY809");
      return(retObjArr);
  } 
