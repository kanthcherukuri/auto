...
public class Admin_ZOY1972_referenceDataEditPermissions extends LoadPropMac
{
	...
	@Test()
	public void referenceDataEditPermission() throws Exception
	{
		...
		Browser.selectbyName("profile.roles.0", "EDIT REFERENCE DATA");
		...
		//Admin user login to check referenceData edit permission
				...
				if(driver.findElements(By.xpath("//button[contains(., 'EDIT')]")).size()>0)
					{
						...
						System.out.println("Edit permission is working as expected for doctor lop");
					}
				...
				if(driver.findElements(By.xpath("//button[contains(., 'EDIT')]")).size()>0)
					{
						...
						System.out.println("Edit permission is working as expected for doctor qualification");
					}
				...
				if(driver.findElements(By.xpath("//button[contains(., 'EDIT')]")).size()>0)
					{
						...
						System.out.println("Edit permission is working as expected for doctor specialization");
					}
		//Doctor tags
				driver.get(tagzqa);
