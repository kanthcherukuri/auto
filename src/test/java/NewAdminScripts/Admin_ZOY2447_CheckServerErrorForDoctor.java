...
public class Admin_ZOY2447_CheckServerErrorForDoctor extends LoadPropMac {
	...
	public void CheckValidation() throws Exception {
		...
		Browser.waitTill(500);
		admin.clickSubmitDoctor();
		boolean abc =Browser.isElementPresent(By.cssSelector("div.zy-global-status"));
		System.out.println("wrapper status"+abc);
...
//	
//	
//	@Test(dataProvider="ServerError",enabled=false)
...
//	String pin, String longitude, String latitude,String notificationerror) throws Exception
//	{
//		admin.click_doctorsTab();
//		admin.click_addDoctor();
...
//		admin.clickSubmitDoctor();
//		
//		boolean Servererror=driver.findElement(By.xpath("//div[@class='zy-status-wrapper']")).isDisplayed();
//		System.out.println(Servererror);
//		Assert.assertEquals(Servererror, "false");
//		
//		WebDriverWait wait = (new WebDriverWait(driver, 60));
//		wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//li[@class='parsley-pattern']")));
//		String ActualNotification= driver.findElement(By.xpath("//li[@class='parsley-pattern']")).getText();
//		System.out.println("ActualNotificationMessage="+ActualNotification);
//		Assert.assertEquals(ActualNotification,notificationerror);
//		Thread.sleep(2000);
//	}
