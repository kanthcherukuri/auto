...
public class Admin_ZOY2057_aptStatusReschedule extends LoadPropMac
{
	...
	public String status = "Reschedule By Doctor"; // Reschedule By Patient OR Reschedule By Doctor
