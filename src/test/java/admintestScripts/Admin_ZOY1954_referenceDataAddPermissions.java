...
public class Admin_ZOY1954_referenceDataAddPermissions extends LoadPropMac
{
	...
	@Test()
	public void referenceDataAddPermission() throws Exception
	{
		...
		Browser.selectbyName("profile.roles.0", "ADD REFERENCE DATA");
		...
		//Admin user login to check referenceData add permission
				...
				if(driver.findElements(By.xpath("//button[contains(., 'EDIT')]")).size()>0)
					{
						...
						System.out.println("Add permission is working as expected for doctor lop");
					}
				...
				if(driver.findElements(By.xpath("//button[contains(., 'EDIT')]")).size()>0)
					{
						...
						System.out.println("Add permission is working as expected for doctor qualification");
					}
				...
				if(driver.findElements(By.xpath("//button[contains(., 'EDIT')]")).size()>0)
					{
						...
						System.out.println("Add permission is working as expected for doctor specialization");
					}
		//Doctor tags
				driver.get(tagzqa);
				...
				if(driver.findElements(By.xpath("//button[contains(., 'EDIT')]")).size()>0)
					{
						...
						System.out.println("Add permission is working as expected for doctor tags");
					}
		//Country
				...
				if(driver.findElements(By.xpath("//button[contains(., 'EDIT')]")).size()>0)
					{
						...
						System.out.println("Add permission is working as expected for countries");
					}
		//State
				driver.get(statezqa);
				...
				if(driver.findElements(By.xpath("//button[contains(., 'EDIT')]")).size()>0)
					{
						...
						System.out.println("Add permission is working as expected for states");
					}
		//City
				driver.get(cityzqa);
				...
				if(driver.findElements(By.xpath("//button[contains(., 'EDIT')]")).size()>0)
					{
						...
						System.out.println("Add permission is working as expected for city");
					}
		//Language
				driver.get(langzqa);
				...
				if(driver.findElements(By.xpath("//button[contains(., 'EDIT')]")).size()>0)
					{
						...
						System.out.println("Add permission is working as expected for language");
					}
	}
