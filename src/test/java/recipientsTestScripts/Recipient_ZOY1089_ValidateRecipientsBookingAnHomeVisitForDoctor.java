...
*/
public class Recipient_ZOY1089_ValidateRecipientsBookingAnHomeVisitForDoctor extends LoadProp {
    ...
    public void LaunchBrowser() throws Exception {
	 ...
	 @DataProvider(name = "DP1")
	    public Object[][] createData_DP1() throws Exception{
	        Object[][] retObjArr=TestUtils.getTableArray("TestData\\Recipients_TestData.xls","Doctor", "ZOY1089");
	        return(retObjArr);
	    }
